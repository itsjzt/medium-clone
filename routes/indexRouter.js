...
router.post('/editor/:posturl', uc.isLoggedIn, catchErrors(pc.updatePost));
router.post('/editor', uc.isLoggedIn, catchErrors(pc.submitPost));
router.get('/like/:posturl', uc.isLoggedIn, catchErrors(pc.likePost));
router.get('/update/:posturl', uc.isLoggedIn, catchErrors(pc.updatePostForm));
router.get('/delete/:posturl', uc.isLoggedIn, catchErrors(pc.deletePost));
